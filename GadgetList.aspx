<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GadgetList.aspx.cs" Inherits="GadgetList" %>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td style="border-bottom-style: solid; border-width: 1px; font-weight: bold; padding-left: 10px;
                                        ...
                                        <br />
                                        <a style="text-decoration: underline" href="GadgetList.aspx"><font color="black">Gadgets
                                            List</font></a>
                                        <br />
                        ...
                        <td width="85%" valign="top" style="padding-right: 10px; padding-left: 10px">
                            <table width="100%">
                                <tr>
                                    <td>
                                        <h2>
                                            <span style="color: Blue; font-size: 140%">&#9632;</span>Gadget advertisements list
                                            :</h2>
                                    </td>
                                </tr>
                                <tr width="100%">
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    ...
                                                    &nbsp&nbsp;<a href="GadgetList.aspx" style="font-size: smaller">Clear search</a>
                                                </td>
                                            </tr>
                                        </table>
                                        <br />
