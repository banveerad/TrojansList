<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Books.aspx.cs" Inherits="Bykes" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<script src="Scripts/booksvalidate.js" type="text/javascript"></script>
                ...
                <table width="100%">
                    <tr width="100%" height="390px">
                        <td style="border-right-style: solid; border-width: 1px" valign="top" class="style3">
                            <table width="100%">
                                ...
                                <tr>
                                    <td style="border-bottom-style: solid; border-width: 1px; font-weight: bold; padding-left: 10px;
                                        font-size: 15px">
                                        <a style="text-decoration: underline" href="Bykes.aspx"><font color="black">Bikes</font></a>
                                        <br />
                        ...
                        <td width="85%" valign="top" style="padding-right: 10px; padding-left: 10px">
                            <fieldset>
                                <h3>
                                    <legend>&nbsp;&nbsp;<span style="color: Lime; font-size: 140%">&#9632;</span>&nbsp;Please
                                        create your advertisement here for Bikes :&nbsp;&nbsp;</legend>
                                </h3>
                                ...
                                <table style="width: 100%">
                                    ...
                                    <tr style="width: 100%">
                                        ...
                                        <td class="style1">
                                            <asp:TextBox runat="server" ID="titleTB" MaxLength="250" ForeColor="Blue"></asp:TextBox>&nbsp;&nbsp;
                                            <label id="lblCaption" style="color: Green">
                                            </label>
                                            <asp:Label ID="errorTitlelbl" runat="server" Style="color: Red" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="width: 100%">
                                        <td class="style2">
                                        ...
                                        <td class="style1">
                                            <asp:TextBox runat="server" ID="yearPublishedTextBox" MaxLength="4" ForeColor="Blue"></asp:TextBox>&nbsp;&nbsp;
                                            <label id="Label1" style="color: Green">
                                            </label>
                                            <asp:Label ID="yearPublishedLabel" runat="server" Style="color: Red" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="width: 100%">
                                        <td class="style2">
                                        ...
                                        <td class="style1">
                                            <asp:TextBox runat="server" ID="authorTextBox" MaxLength="250" ForeColor="Blue"></asp:TextBox>&nbsp;&nbsp;
                                            <label id="Label3" style="color: Green">
                                            </label>
                                            <asp:Label ID="authorLabel" runat="server" Style="color: Red" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="width: 100%">
                                        <td class="style2">
                                            <label>
                                                Publications<span style="color: Red">*</span>
                                            </label>
                                        </td>
                                        <td class="style1">
                                            <asp:TextBox runat="server" ID="publicationsTextBox" MaxLength="250" ForeColor="Blue"></asp:TextBox>&nbsp;&nbsp;
                                            <label id="Label5" style="color: Green">
                                            </label>
                                            <asp:Label ID="publicationsLabel6" runat="server" Style="color: Red"
                                                Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="width: 100%">
                                        ...
                                        <td class="style1">
                                            <asp:TextBox runat="server" ID="isbnTextBox" MaxLength="250" ForeColor="Blue"></asp:TextBox>&nbsp;&nbsp;
                                            <label id="Label7" style="color: Green">
                                            </label>
                                            <asp:Label ID="isbnLabel" runat="server" Style="color: Red" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="width: 100%">
                                        <td class="style2">
                                        ...
                                        <td class="style1">
                                            <asp:TextBox runat="server" ID="expectedTextBox" MaxLength="5" ForeColor="Blue"></asp:TextBox>
                                    ...
                                    <tr style="width: 100%">
                                        <td colspan="2" style="padding-left: 250px">
                                            <asp:Button ID="buttonSubmit" runat="server" Text="Create" Enabled="false" OnClick="submit_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </fieldset>
