    ...
    protected void BTN_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (codeSent == TxtCode.Text.Trim())
            {
                ...
                INcommand1.CommandText = "insert into furniture (name,mail,phonenumer,product,descp,price,createdOn) values(@name,@email,@phoneno,@product,@descp,@price,@createdOn)";
