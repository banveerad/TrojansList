<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Housing.aspx.cs" Inherits="Furnitures" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<script src="Scripts/housingvalidatenew.js" type="text/javascript"></script>
                ...
                <table width="100%">
                    <tr width="100%" height="390px">
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td style="border-bottom-style: solid; border-width: 1px; font-weight: bold; padding-left: 10px;
                                        ...
                                        <br />
                                        <a style="text-decoration: underline" href="Housing.aspx"><font color="black">Housing</font></a>
                                        <br />
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <td width="85%" valign="top" style="padding-right: 10px; padding-left: 10px">
                            <fieldset>
                                <h3>
                                    <legend>&nbsp;&nbsp;<span style="color: Aqua; font-size: 140%">&#9632;</span>&nbsp;Please
                                        create your advertisement here for housing :&nbsp;&nbsp;</legend>
                                </h3>
                                ...
                                <table style="width: 100%">
                                    <tr style="width: 100%">
                                        ...
                                        <td class="style1">
                                            <asp:TextBox runat="server" ID="fullNameTxtBox" MaxLength="30" ForeColor="Blue"></asp:TextBox>&nbsp;&nbsp;<asp:Label
                                    ...
                                    <tr style="width: 100%">
                                        <td class="style2">
                                            <label>
                                                Looking for <span style="color: Red">*</span>
                                            </label>
                                        </td>
                                        <td class="style1">
                                            <asp:DropDownList runat="server" ID="watTextBox">
                                            ...
                                            <asp:Label ID="watLabel" runat="server" Style="color: Red" Text=""></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="width: 100%">
                                        <td class="style2">
                                    ...
                                    <tr style="width: 100%">
                                        <td class="style2">
                                            <label>
                                                Looking for gender <span style="color: Red">*</span>
                                            </label>
                                        </td>
                                        <td class="style1">
