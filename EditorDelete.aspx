<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditorDelete.aspx.cs" Inherits="EditorDelete" %>
                                    ...
                                    <td width="100%" align="center" colspan="3">
                                        <h3>
                                            <legend>&nbsp;&nbsp;<span style="color: Lime; font-size: 140%">&#9632;</span>&nbsp;Please
                                                select the section for which you want to edit or Delete your advertisements&nbsp;&nbsp;</legend>
                                        </h3>
                                    </td>
                                </tr>
                                <tr style="width=100%">
                                    <td style="font-weight: bold; text-align: center; font-size: 15px; width: 25%">
                                        <a class="myclass" href="EditorDeleteBikes.aspx"><font color="Red">Edit/Delete Bikes
                                            Ad</font></a>
                                    </td>
                                    <td style="font-weight: bold; text-align: center; font-size: 15px; width: 25%">
                                        <a class="myclass" href="EditorDeleteFurnitures.aspx"><font color="Red">Edit/Delete
                                            Furniture Ad</font></a>
                                    </td>
                                    <td style="font-weight: bold; text-align: center; font-size: 15px; width: 25%">
                                        <a class="myclass" href="EditorDeleteGadgets.aspx"><font color="Red">Edit/Delete Gadgets
                                            Ad</font></a>
                                    </td>
                                    <td style="font-weight: bold; text-align: center; font-size: 15px; width: 25%">
                                        <a class="myclass" href="EditorDeleteHousings.aspx"><font color="Red">Edit/Delete Housing
                                            Ad</font></a>
                                    </td>
                                </tr>
                            </table>
