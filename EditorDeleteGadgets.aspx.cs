...
public partial class EditorDeleteGadgets : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT id,product,descp,price FROM gadgets where mail='" + mailTxtBox.Text + "' order by createdOn desc", con);
        ...
        try
        {
            ...
            else
            {
                if (serverSideValidation(((TextBox)GridView1.Rows[e.RowIndex].Cells[3].Controls[0]).Text.Trim(), ((TextBox)GridView1.Rows[e.RowIndex].Cells[4].Controls[0]).Text.Trim()))
                {
                    ...
                    cmd.CommandText = "UPDATE gadgets SET descp=@cat_name,price=@price,createdOn='" + DateTime.Now + "' WHERE id=@cat_id";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["uscresellall"].ConnectionString);
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "DELETE FROM gadgets WHERE id=@cat_id";
