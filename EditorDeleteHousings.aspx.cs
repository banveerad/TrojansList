...
public partial class EditorDeleteFurnitures : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SELECT id,Lookingfor,descp,gender FROM housing where mail='" + mailTxtBox.Text + "' order by createdOn desc", con);
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        try
        {
            ...
            {
                if (serverSideValidation(((TextBox)GridView1.Rows[e.RowIndex].Cells[3].Controls[0]).Text.Trim(), "ads"))
                {
                    SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["uscresellall"].ConnectionString);
                    SqlCommand cmd = new SqlCommand();
                    cmd.CommandText = "UPDATE housing SET descp=@cat_name,createdOn='" + DateTime.Now + "' WHERE id=@cat_id";
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["uscresellall"].ConnectionString);
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "DELETE FROM housing WHERE id=@cat_id";
