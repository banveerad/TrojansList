...
public partial class GadgetList : System.Web.UI.Page
{
    ...
    protected void sendMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Session["sub"] = "Response to your gadget Ad";
    ...
    private DataView bindgrid()
    {
        try
        {
            ...
            {
                StrQuery = "select * from gadgets order by createdOn desc";
                withResearch.Visible = false;
            }
            else
            {
                StrQuery = "select * from gadgets where product like '%" + productTxtBox.Text + "%' order by createdOn desc";
