<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Furnitures.aspx.cs" Inherits="Furnitures" %>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td style="border-bottom-style: solid; border-width: 1px; font-weight: bold; padding-left: 10px;
                                        ...
                                        <br />
                                        <a style="text-decoration: underline" href="Furnitures.aspx"><font color="black">Furniture</font></a>
                                        <br />
                            ...
                            <fieldset>
                                <h3>
                                    <legend>&nbsp;&nbsp;<span style="color: Aqua; font-size: 140%">&#9632;</span>&nbsp;Please
                                        create your advertisement here for Furnitures :&nbsp;&nbsp;</legend>
                                </h3>
