<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditorDeleteBikes.aspx.cs"
    Inherits="EditorDeleteBikes" %>
                                ...
                                <tr style="width: 100%">
                                    <td colspan="2">
                                        ...
                                        <asp:GridView ID="GridView1" Visible="false" runat="server" AutoGenerateColumns="False"
                                            CellPadding="4" DataKeyNames="id" OnRowCancelingEdit="GridView1_RowCancelingEdit"
                                            OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating"
                                            AllowPaging="True" OnPageIndexChanging="grdView_PageIndexChanging" Width="100%"
                                            BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px">
                                            <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
                                            <Columns>
                                                <asp:CommandField HeaderText="Edit-Update" ShowEditButton="True" ItemStyle-HorizontalAlign="Center"
                                                    ItemStyle-Width="15%">
                                                ...
                                                <asp:BoundField DataField="descp" HeaderText="Description" ItemStyle-HorizontalAlign="Center"
                                                    ControlStyle-Width="55%">
