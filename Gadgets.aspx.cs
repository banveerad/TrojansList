    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        try
        {
            if (serverSideValidation())
            {
                ...
                SqlCommand INcommand1 = new SqlCommand("select createdOn from userEmails where emailId='" + uscEmsilTextBox.Text + "'");
    ...
    protected void BTN_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (codeSent == TxtCode.Text.Trim())
            {
                ...
                INcommand1.CommandText = "insert into gadgets (name,mail,phonenumer,product,descp,price,createdOn) values(@name,@email,@phoneno,@product,@descp,@price,@createdOn)";
                ...
                INcommand1.Parameters.AddWithValue("@product", watTextBox.Text.Trim());
    ...
    private bool serverSideValidation()
    {
        try
        {
            ...
            if (nameemptyProd == 0)
            {
                ...
                {
                    watLabel.Text = "Field can't be greater than 40";
                    isprob = 1;
                }
                else
                {
