<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditorDeleteGadgets.aspx.cs"
    Inherits="EditorDeleteGadgets" %>
                            ...
                            <table width="100%">
                                ...
                                <tr>
                                    <td style="font-weight: bold; text-align: center; font-size: 15px">
                                        <a cstyle="text-decoration: underline" href="EditorDelete.aspx"><font color="Red">Edit/Delete</font></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                                ...
                                <tr width="100%">
                                    <td width="100%" align="center" colspan="2">
                                        <h3>
                                            ...
                                            advertisement for gadgets here&nbsp;&nbsp;
                                        </h3>
                                    </td>
                                </tr>
                                <tr style="width: 100%">
